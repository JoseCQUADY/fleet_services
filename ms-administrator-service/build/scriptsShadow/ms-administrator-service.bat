...
set CLASSPATH=%APP_HOME%\lib\ms-administrator-service-0.1-all.jar

@rem Execute ms-administrator-service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MS_ADMINISTRATOR_SERVICE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MS_ADMINISTRATOR_SERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
